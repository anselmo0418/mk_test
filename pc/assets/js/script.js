...
function setTabUi(idx) {
  ...
  const tabNav = tabWrap.querySelectorAll('.tab_nav .btn')
  let useNav = false
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // 헤더 언어변경 On / Off
  const langBtn = document.querySelector('header .drop_menu_btn');
  const langMenu = document.querySelector('header .drop_menu_wrap');
  ...
  if(langBtn) {
    langBtn.addEventListener('click', function () {
      ...
      if (langMenuActive) {
        ...
        langMenu.classList.add('is_active');
      } else {
        langBtn.classList.remove('active');
        langMenu.classList.remove('is_active');
      }
    });
  }
  ...
  const filterRemoveBtn = document.querySelectorAll('.remove_filter');
  filterRemoveBtn.forEach(function (el) {
...
(function ($) {
  ...
  $('.datepicker_filter').datepicker({
    ...
    onSelect: function (val, inst) {
      ...
      if (dateTo) {
        ...
        var tabIdx = inst.dpDiv.closest('.drop_down_wrap').data('filter');
        ...
        $('.for_datepicker').prop('checked', false);
      }
    },
  });
  ...
  $('.open_filter').on('click', function () {
    if ($('.filter_wrap').hasClass('is_active')) {
      $('.filter_wrap').removeClass('is_active');
      $('.selected_filter_wrap').removeClass('is_active');
    } else {
      $('.filter_wrap').addClass('is_active');
      $('.selected_filter_wrap').addClass('is_active');
    }
  });
