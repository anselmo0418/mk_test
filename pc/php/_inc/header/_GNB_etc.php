<section class="gnb">
	<div class="set_inner clearFix">
		<button class="nav_link open_full_menu_btn" onclick="totalMenuSwitch(this)">
		...
		<nav class="nav_wrap main_menu_nav menu_wrap main_menu_wrap">
			<ul class="nav menu_list main_menu_list">
				<li class="nav_item main_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>뉴스</span></a></li>
				<li class="nav_item main_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>프리미엄</span></a></li>
				<li class="nav_item main_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>증권</span></a></li>
				<li class="nav_item main_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>부동산</span></a></li>
				<li class="nav_item main_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>교육</span></a></li>
			</ul>
		</nav>
		<nav class="nav_wrap setting_menu_nav menu_wrap setting_menu_wrap">
			<ul class="nav menu_list setting_menu_list">
				<li class="nav_item menu_node">
					<a href="javascript:;" class="nav_link menu_item btn_search" onclick="totalSearchSwitch(this)">
						<i class="ic ic_search"></i>
						<span class="is_blind">통합검색</span>
					</a>
				</li>
				<li class="nav_item setting_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>로그인</span></a></li>
				<li class="nav_item setting_menu_node"><a href="javascript:;" class="nav_link menu_item"><span>회원가입</span></a></li>
			</ul>
		</nav>
	</div>
</section>