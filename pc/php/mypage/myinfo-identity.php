            ...
            <article class="account_sec">
              ...
              <div class="sec_body">
                    ...
                    <div class="email_join_group">
                      ...
                      <form action="" class="join_form">
                        ...
                        <div class="btn_area taR">
                          <button class="btn strong h_m">이메일 회원가입</button>
                        </div>
                      </form>
                    </div>
                    <dl class="label_list">
                ...
                <div class="info_wrap identity_info_wrap">
                  ...
                  <div class="info_wrap_body">
                    <dl class="label_list">
                      <dt><span class="label">본인 확인</span></dt>
                      <dd>
                        <span>2022.03.15</span>
                        <div class="btn_area">
                          <button class="btn basic w_s h_s">재인증</button>
                        </div>
                      </dd>
                    </dl>
                    <dl class="label_list">
                    ...
                    <dl class="label_list">
                      <dt><span class="label">성별</span></dt>
                      <dd>
                        <span>남자</span>
                      </dd>
                    </dl>
                    <dl class="label_list">
                      <dt><span class="label">휴대폰 번호</span></dt>
                      <dd>
                        <span>010-1234-5678</span>
                      </dd>
                    </dl>
	                  <div class="addr_group">
	                    <dl class="label_list addr_area">
	                      <dt><span class="label">주소</span></dt>
	                      <dd>
	                        <div class="input_group type_addr">
	                          <div class="input_area type_hrz">
	                            <div class="input_box"><input type="text" title="우편번호" value="12345" readonly></div>
	                            <button class="btn basic w_s h_l">주소 수정</button>
	                          </div>
	                          <div class="input_area type_hrz">
	                            <div class="input_box"><input type="text" title="주소" value="서울 중구 충무로 2 (필동1가, 매일경제신문사빌딩)" readonly></div>
	                          </div>
	                          <div class="input_area type_hrz">
	                            <div class="input_box"><input type="text" title="상세주소"  value="매경미디어센터 1층"></div>
	                          </div>
	                        </div>
	                      </dd>
	                    </dl>
		                  <dl class="label_list addr_area btn_area">
			                  <dt></dt>
			                  <dd>
				                  <button class="btn strong w_m h_l">저장</button>
			                  </dd>
		                  </dl>
	                  </div>
                  </div>
