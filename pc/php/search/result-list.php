...
<main id="container">
	...
	<section class="contents search_page">
						...
						<div class="tab_wrap tab_ui">
							<div class="has_scroll_x type_hidden">
								<ul class="nav tab_nav tab_list" role="tablist">
									...
									<li class="nav_item tab_node" role="presentation">
										<a href="#" id="news" class="nav_link tab_item w_l" role="tab" aria-controls="news_cnt" aria-selected="true">뉴스</a>
									</li>
									<li class="nav_item tab_node" role="presentation">
        ...
        <div id="news_cnt" class="tab_pane active" role="tabpanel" aria-labelledby="news_cnt">
				  <div class="grid grid_custom type_2">
					<div class="col main_col">
						<section class="news_sec latest_news_sec">
							<header class="sec_head">
								<div class="type_underline">
									<h2 class="sec_ttl">경제용어 <span class="num">825</span></h2>
