...
<!-- s: Container -->
	<main id="container">
		<section class="contents account_page login_page join_age_page">
			<div class="min_inner">
				<article class="account_sec join_sec">
					...
					<form action="" class="account_form account_wrap join_wrap">
						<div class="input_area is_error">
							...
							<div class="input_box">
								<input id="mail" type="text" placeholder="이메일 주소를 입력하세요.">
						...
						<div class="input_group age_group">
							...
							<div class="btn_area">
								<button class="btn basic w_f h_m type_round">법정대리인 본인 확인</button>
							</div>
						</div>
						<div class="input_group agree_group">
							<div class="input_area check is_all">
								...
								<div class="input_box">
									...
									<button type="button" class="btn btn_txt has_underL" id="openTerms" onclick="showlayer(this, '#termsModal')">보기</button>
								</div>
								<div class="input_box">
									...
									<button type="button" class="btn btn_txt has_underL" id="openPrivacy" onclick="showlayer(this, '#privacyModal')">보기</button>
								</div>
								<div class="input_box">
