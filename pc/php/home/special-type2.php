...
<!-- e: Header -->
	...
	<main id="container">
					...
					<div class="grid grid_custom type_1">
                        ...
                        <a href="#" class="link" aria-describedby="headline_1"></a>
												<div class="txt_area">
													...
													<h3 id="headline_1" class="news_ttl"><span class="badge type_line">긴급</span>오미크론 확진 12명 늘어
      ...
      <div class="mk_body_news_group">
        <div class="set_inner">
	        <?php include_once '../_inc/main/BodySpecialNews.php'; ?>
				              ...
				              <li class="col news_node highlight_news_node">
					              <div class="news_item highlight_news_item type_banner type_desc">
						              ...
						              <div class="txt_area">
							              ...
							              <h3 i="text" class="news_ttl">中과 특수성 강조한 文
								              “베이징올림픽 보이콧 검토안해”</h3>
