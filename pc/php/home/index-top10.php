								...
								<div class="sec_body">
									<ul class="grid no_gap news_list headline_news_list">
										<li class="col col_12 news_node headline_news_node"
										    style="background-image: url('../../assets/images/img_news_ttl_02.png')">
                        ...
                        <a href="#" class="link" aria-describedby="headline_1"></a>
										...
										<li class="col col_4 news_node headline_news_node">
											<div class="news_item headline_news_item">
												...
												<div class="txt_area">
													<h3 id="headline_2" class="news_ttl"><span class="badge">긴급</span>“잠깐 스쳤을 뿐인데,
														오미크론 걸렸다”…
														“공기전파 가능성 주시”</h3>
										...
										<li class="col col_4 news_node right headline_news_node type_bg"
											...
											<div class="news_item headline_news_item">
												...
												<div class="txt_area">
													<h3 id="headline_4" class="news_ttl"><span class="badge">긴급</span>“돌파감염자 수퍼 항체 생겼다…2차 접종 후 2주…</h3>
												</div>
											</div>
										</li>
...
<?php include_once '../_inc/_footer.php'; ?>
	...
	<script>
		const gnbMenu = document.querySelectorAll('.gnb .main_menu_nav .nav_item')
		const LnbMenu = document.querySelectorAll('.lnb .dep2_nav .nav_item')
		console.log(gnbMenu, LnbMenu)
		gnbMenu[0].firstChild.classList.add('active')
		LnbMenu[1].firstChild.classList.add('active')
	</script>
