						...
						<section class="news_sec headline_news_sec">
							...
							<div class="sec_body">
								<ul class="grid no_gap news_list headline_news_list">
									<li class="col col_12 news_node headline_news_node no_dim">
										<div class="news_item type_headline headline_news_item">
                      <a href="#" class="link" aria-describedby="headline_1"></a>
									...
									<li class="col col_4 news_node headline_news_node">
										<div class="news_item headline_news_item">
											...
											<div class="txt_area">
												<h3 id="headline_2" class="news_ttl">“잠깐 스쳤을 뿐인데,
													오미크론 걸렸다”…
													“공기전파 가능성 주시”</h3>
									...
									<li class="col col_4 news_node right headline_news_node type_bg">
										<div class="news_item headline_news_item">
											...
											<div class="thumb_area" style="background-image: url('../../assets/images/img_headline_02.png')">
											</div>
											<div class="txt_area">
						...
						<section class="news_sec top_news_sec" data-top-news="timeline">
							...
							<div class="sec_body">
								<div class="timeline_news_wrap">
									<h3 class="timeline_ttl">오미크론, 그게 대체 뭔데? 😚</h3>
		              ...
		              <ul class="news_list highlight_news_list grid">
			              ...
			              <li class="col news_node highlight_news_node">
				              <div class="news_item highlight_news_item type_banner type_desc">
					              <a href="#" aria-describedby="text1" class="link"><span class="is_blind">기사링크</span></a>
					              <div class="thumb_area">
						              <img src="../../assets/images/img_highlight_02.png" alt="">
					              </div>
					              <div class="txt_area">
						              <span class="cate">경제</span>
						              <h3 id="text1" class="news_ttl">中과 특수성 강조한 文
							              “베이징올림픽 보이콧 검토안해”</h3>
		              ...
		              <ul class="grid news_list highlight_news_list">
			              ...
			              <li class="col col_6 news_node">
				              <div class="news_item highlight_news_item">
					              ...
					              <div class="txt_area">
						              <h3 id="today_news" class="news_ttl">매경·NH證 `착한기업` 지수 추종…초과수익까지 노린다</h3>
						              <div class="info_group">
			              ...
			              <li class="col col_6 news_node">
				              <div class="news_item highlight_news_item">
					              ...
					              <div class="txt_area">
						              <h3 id="today_news" class="news_ttl">“대선 의식했나”…내년 1분기까지 전기요금 동결</h3>
						              <div class="info_group">
