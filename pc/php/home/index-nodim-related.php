				...
				<div class="set_inner">
					<div class="grid grid_custom type_1">
									...
									<ul class="grid no_gap news_list headline_news_list">
										<li class="col col_12 news_node headline_news_node no_dim related_type">
											<div class="news_item headline_news_item type_headline">
												...
												<div class="thumb_area" style="background-image: url('../../assets/images/img_headline_01.png')">
												</div>
										...
										<li class="col col_4 news_node headline_news_node">
											<div class="news_item headline_news_item">
												...
												<div id="headline_2" class="txt_area">
													<h3 class="news_ttl"><span class="badge">긴급</span>“잠깐 스쳤을 뿐인데,
														오미크론 걸렸다”…
														“공기전파 가능성 주시”</h3>
										...
										<li class="col col_4 news_node right headline_news_node type_bg">
											<div id="headline_4" class="news_item headline_news_item">
												...
												<div class="thumb_area" style="background-image: url('../../assets/images/img_headline_02.png')"></div>
												<div class="txt_area">
													<h3 class="news_ttl"><span class="badge">단독</span>“돌파감염자 수퍼 항체 생겼다…2차 접종 후 2주…</h3>
												</div>
											</div>
										</li>
										<li class="col col_8 news_node headline_news_node">
											<div class="news_item headline_news_item type_small">
												...
												<div class="txt_area">
													<h3 class="news_ttl"><span class="badge">단독</span> “1975년생 직장인 여성 5명중 1명은 무자녀”</h3>
						...
						<div class="col sub_col">
							<section class="news_sec top_news_sec is_active" data-top-news="top">
								<header class="sec_head">
							...
							<section class="news_sec top_news_sec" data-top-news="timeline">
								<header class="sec_head">
									<div class="btn_area mode_change_area">
										...
										<ul class="news_list timeline_news_list">
											<li class="news_node timeline_news_node">
												<a href="#" class="news_item timeline_news_item">
													...
													<div class="txt_area">
														<h4 class="news_ttl"><span class="badge">긴급</span>‘오미크론’ 첫 발생 5일 만에
															아프리카→일본서 발견</h4>
													</div>
													<div class="info_group">
														<p class="like_info">좋아요 <span>25</span></p>
			              ...
			              <ul class="news_list highlight_news_list grid">
				              <li class="col news_node highlight_news_node">
					              <div class="news_item highlight_news_item type_banner">
						              ...
						              <div class="txt_area">
							              ...
							              <h3 id="text" class="news_ttl"><span class="badge">긴급</span>‘절대 안찍을 후보’ 조사
								              윤석열 39.5% 득표… 이재명은</h3>
							              <div class="info_group">
				              ...
				              <li class="col col_4 news_node highlight_news_node">
					              <div class="news_item highlight_news_item type_thumb">
						              ...
						              <div class="txt_area">
							              <h3 class="news_ttl"><span class="badge">긴급</span>38년간 레고로 놀며 ‘꿈의 자격증’ 딴 건축설계사</h3>
							              <div class="info_group">
								              <p class="time_info">3분 전</p>
			              ...
			              <ul class="grid news_list highlight_news_list">
				              <li class="col col_6 news_node">
					              <div class="news_item highlight_news_item">
						              ...
						              <div class="txt_area">
							              <h3 class="news_ttl"><span class="badge">긴급</span>삼성전자 D램 점유율 1위…반도체 전망도 밝다</h3>
							              <div class="info_group">
								              <p class="time_info">3분 전</p>
								              <p class="like_info">좋아요 <span>22</span></p>
							              </div>
				              ...
				              <li class="col col_6 news_node">
					              <div class="news_item highlight_news_item">
						              ...
						              <div class="txt_area">
							              <h3 class="news_ttl"><span class="badge">긴급</span>중부내륙선 철도건설사업 이천~충주(54km)구간 우선개통</h3>
							              <div class="info_group">
											...
											<li class="news_node">
												<a href="#" class="news_item">
													...
													<div class="txt_area">
														...
														<h3 class="news_ttl"><span class="badge">긴급</span>경제안보전략 큰 그림이 안 보인다</h3>
													</div>
												</a>
											</li>
											<li class="news_node">
										...
										<ul class="grid news_list stock_news_list">
											<li class="col col_6 news_node">
												<a href="" class="news_item">
													...
													<div class="txt_area">
														<h3 class="news_ttl"><span class="badge">긴급</span>“삼성과 격차 더 커졌다”…진격의 TSMC, 전세계 파운드리 `절반` 독식</h3>
														<div class="info_group">
															<p class="time_info">3분 전</p>
															<p class="like_info">좋아요 <span>12</span></p>
														</div>
								...
								<section class="news_sec stock_news_sec">
									<div class="stock_news_wrap">
										<ul class="news_list stock_news_list type_txt">
											<li class="news_node">
												<a href="" class="news_item">
													<h3 class="news_ttl"><span class="badge">긴급</span>“나만 재밌는거 아니었네”…엔씨, ‘리니지W’ 역대급</h3>
												</a>
											</li>
											<li class="news_node">
												<a href="" class="news_item">
											...
											<li class="news_node">
												<a href="" class="news_item">
													<h3 class="news_ttl"><span class="badge">긴급</span>“어디까지 오를까”…날아오르는 애플 주가에 국내 수…</h3>
												</a>
											</li>
											<li class="news_node">
												<a href="" class="news_item">
									...
									<ul class="grid news_list stock_news_list">
										...
										<li class="col col_6 news_node">
											<a href="" class="news_item">
												...
												<div class="txt_area">
													<h3 class="news_ttl"><span class="badge">긴급</span>넉달 동안 -40%… SK바사에 1000억원 공매도 폭탄</h3>
													<div class="info_group">
														<p class="time_info">3분 전</p>
														<p class="like_info">좋아요 <span>50</span></p>
													</div>
