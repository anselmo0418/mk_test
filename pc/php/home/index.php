				...
				<div class="set_inner">
					...
					<div class="sec_body">
						<div class="special_news_wrap">
							<ul class="news_list special_news_list grid grid_15">
								...
								<li class="news_node col col_3">
									<a href="#" class="news_item type_img banner_link">
										<div class="thumb_area">
											<img src="../../assets/images/img_special_link01.png" alt="">
										</div>
								...
								<li class="news_node col col_6">
									<a href="#" class="news_item">
										<div class="txt_area" role="text">
											<h3 class="news_ttl">“오토데스크 설계플랫폼서 테슬라·현대차·폭스바겐…미래 혁신기술 그려냈죠”</h3>
											<p class="news_desc">오미크론 확진 초비상
												결국 국내에서도 오미크론 변이 감염자가 나왔다. </p>
										</div>
										<div class="info_group">
			...
			<div class="set_inner">
				<div class="grid grid_custom type_1">
						...
						<section class="news_sec headline_news_sec">
							...
							<div class="sec_body">
								<ul class="grid no_gap news_list headline_news_list">
									<li class="col col_12 news_node headline_news_node no_dim related_type">
										<a href="#" class="link" aria-describedby="headline_1"></a>
										<div class="news_item headline_news_item">
											<div class="thumb_area"
											     style="background-image: url('../../assets/images/img_headline_01.png')">
											</div>
											<div class="txt_area">
										...
										<div class="news_item headline_news_item">
											...
											<div class="txt_area">
												<h3 id="headline_2" class="news_ttl"><span class="badge type_line">긴급</span>“잠깐 스쳤을 뿐인데,
													오미크론 걸렸다”…
													“공기전파 가능성 주시”</h3>
												<p class="news_desc">수도권 병상 꽉 찼는데…최후의 보루 국립의료원 여전히 ‘뒷짐’수도권 병상 꽉
													찼는데…최후의 보루 국립의료원 여전히 ‘뒷짐’수도권 병상 꽉 찼는데…최후의 보루 국립의료원 여전히 ‘뒷짐’</p>
												<div class="info_group">
									...
									<li class="col col_4 news_node headline_news_node">
										<div class="news_item headline_news_item">
											...
											<div id="headline_3" class="txt_area">
												<h3 class="news_ttl">김총리 “오늘 코로나19 확진자 첫 7000명 돌파”</h3>
												<p class="news_desc">김부겸 국무총리는 8일 신종 코로나바이러스 감염증(코로나19) 방역 상황에 대해
													“지난주 하루 확진자가 5000명을 넘어섰고 오늘은
													7000명을 돌파하…</p>
												<div class="info_group">
									...
									<li class="col col_4 news_node right headline_news_node type_bg"
									    style="background-image: url('../../assets/images/img_headline_02.png')">
										<div id="headline_4" class="news_item headline_news_item">
											<a href="#" class="link" aria-describedby="headline_4"></a>
											<div class="txt_area">
												<h3 class="news_ttl">“돌파감염자 수퍼 항체 생겼다…2차 접종 후 2주…</h3>
											</div>
										</div>
									</li>
										...
										<div class="news_item headline_news_item type_small">
											...
											<div class="txt_area">
												<h3 class="news_ttl"><span class="badge">단독</span> “1975년생 직장인 여성
													5명중 1명은 무자녀”</h3>
												<p class="news_desc">1970년대 이후 출생부터 고학력·직장인 여성 출산율이 급격히 감소한 것이
													통계…</p>
												<div class="info_group">
									...
									<li class="col col_4 right news_node headline_news_node">
										<div class="news_item headline_news_item type_small">
											...
											<div class="txt_area">
												<h3 class="news_ttl">오늘부터 요소수 ‘온라인판매’ 돌입… 한 아이디…</h3>
												<div class="info_group">
													<p class="time_info">30분 전</p>
					...
					<div class="col sub_col">
						<section class="news_sec top_news_sec is_active">
							<header class="sec_head">
								<div class="btn_area mode_change_area">
									<button class="btn_mode_change">
						...
						<section class="news_sec top_news_sec">
							<header class="sec_head">
								<div class="btn_area mode_change_area">
									<button class="btn_mode_change short">
										...
										<li class="col news_node highlight_news_node">
											<div class="news_item highlight_news_item type_banner">
												...
												<div class="txt_area">
													...
													<h3 id="text" class="news_ttl"><span class="badge type_line">긴급</span>‘절대 안찍을 후보’ 조사
														윤석열 39.5% 득표… 이재명은</h3>
													<div class="info_group">
												...
												<div class="txt_area">
													...
													<ul class="related_news_list">
														<li>
															...
															<a href="#" class="related_news_item">코로나 장기화에 보건소 대응인력
																절반 ‘고도의 스트레스 상태’</a>
														</li>
														<li>
								...
								<div class="photo_news_wrap swiper-container">
									<div class="photo_list swiper-wrapper">
										...
										<div class="photo_node swiper-slide">
											<a href="" class="photo_item">
												<div class="thumb_area">
													<img src="../../assets/images/img_summary_news01.png" alt="">
												</div>
												<div class="txt_area">
													<em>인기포토N</em>
													<h3 class="photo_ttl">
											...
											<a href="" class="news_item">
												...
												<div class="txt_area">
													...
													<div class="info_group">
														<p class="time_info">3분 전</p>
														<p class="like_info">좋아요 <span>12</span></p>
														<p class="like_info">가장 공유가 많이 된 기사</p>
													</div>
												</div>
											</a>
										</li>
