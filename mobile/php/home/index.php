    ...
    <main id="container">
        ...
        <section class="contents news_home">
            <div class="mk_head_news_group">
                <section class="news_sec special_news_sec">
                    <header class="sec_head">
                        <img src="../../assets/images/img_special_banner01.png" alt="">
                        <div class="is_blind" role="img">
                            <h2>WORLD KNOWLEDGE FORUM 2021</h2>
                            <p>테라 인코그니타 : 공존을 위한 새로운 시대정신을 찾아</p>
                            <p>2021년 9월 14일에서 16일까지 ㅣ Seoul, Korea</p>
                        </div>
                    </header>
                    <div class="sec_body">
                        <div class="special_news_wrap">
                            <ul class="news_list special_news_list grid">
                                <li class="news_node col col_12">
                                    <a href="#" class="news_item type_thumb2">
                                        <!--Dev: 썸네일은 background-image로-->
                                        <div class="thumb_area">
	                                        <img src="../../assets/images/img_special_01.png" alt="">
                                        </div>
                                        <div class="txt_area" role="text">
                                            <h3 class="news_ttl">마이클 샌델,<br>
                                                2021년 대한민국 공정을 말하다…</h3>
                                            <div class="info_group">
                                                <p class="time_info">28분 전</p>
                                                <p class="like_info">좋아요 <span>22</span></p>
                                                <p class="feature_info">가장 공유가 많이 된 기사</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                <li class="news_node col col_6">
                                    <div class="news_item headline_news_item">
                                        ...
                                        <div class="txt_area" role="text">
                                            <h3 class="news_ttl">코로나 지원금 공짜아냐…韓나랏빚 ‘경고등’</h3>
                                            <div class="info_group">
                                ...
                                <li class="news_node col col_6">
                                    ...
                                    <div class="news_item headline_news_item type_bg"
                                         style="background-image: url('../../assets/images/img_special_thumb_1.png');">
                                        <a href="#" class="link"></a>
                                        <div class="txt_area">
                                            <h3 class="news_ttl">"돌파감염자 수퍼 항체 생겼다... 2차 접종 후 2주 돌파감염자 수퍼 항체 생겼다..."</h3>
                                        </div>
                                    </div>
                                </li>
                                <li class="news_node col col_12">
                                    ...
                                    <div class="news_item headline_news_item type_small">
                                        <a href="#" class="link"></a>
                                        <div class="txt_area">
                                            <h3 class="news_ttl">“묘한 중독성·충성도 높은 팬덤…
                                                K팝 위상은 굳건”</h3>
                                            <div class="info_group">
                                ...
                                <li class="news_node col col_12">
                                    ...
                                    <div class="news_item headline_news_item type_small">
                                        <a href="#" class="link"></a>
                                        <div class="txt_area">
                                            <h3 class="news_ttl">“2025년 세계 첫 탄소중립 수도”
                                                코펜하겐의 순환경제 3色전략</h3>
                                            <div class="info_group">
                                                <p class="time_info">30분 전</p>
                                ...
                                <li class="news_node col col_12">
                                    ...
                                    <div class="news_item headline_news_item type_small">
                                        <a href="#" class="link"></a>
                                        <div class="txt_area">
                                            <h3 class="news_ttl">“팬데믹의 역설, 수명연장 앞당긴다”</h3>
                                            <div class="info_group">
                                                <p class="time_info">30분 전</p>
                                                <p class="like_info">좋아요 <span>15</span></p>
                                            </div>
                    ...
                    <div class="sec_body">
                        <ul class="grid news_list headline_news_list">
                            <li class="col col_12 news_node headline_news_node">
                                ...
                                -->
                                <div class="news_item headline_news_item type_headline has_related">
                                  <a href="#" class="link" aria-describedby="headline_1"></a>
                                    <div class="thumb_area">
	                                    <img src="../../assets/images/img_headline_03.png" alt="">
                                    </div>
                                    <div id="headline_1" class="txt_area">
                                        ...
                                        <ul class="related_news_list">
                                            <li>
                                                ...
                                                <a href="#" class="related_news_item">코로나 장기화에 보건소 대응인력 절반 ‘고도의 스트레스
                                                    상태’</a>
                                            </li>
                                            <li>
                            ...
                            <li class="col col_12 news_node headline_news_node">
                                <div class="news_item headline_news_item">
                                    ...
                                    <div id="headline_2" class="txt_area">
                                        <h3 class="news_ttl"><span class="badge type_line">긴급</span>"잠깐 스쳤을 뿐인데, 오미크론 걸렸다"... "공기전파 가능성 주시"</h3>
                                        <div class="info_group">
                            ...
                            <li class="col col_12 news_node headline_news_node">
                                ...
                                <div class="news_item headline_news_item type_small">
                                    ...
                                    <div class="txt_area">
                                        <h3 class="news_ttl">오늘부터 요소수 '온라인판매' 돌입... 한 아이디 오늘부터 요소수 '온라인판매' 돌입... 한
                                            아이디</h3>
                                        <div class="info_group">
                                            <p class="time_info">30분 전</p>
                                            <p class="like_info">좋아요 <span>15</span></p>
                ...
                <section class="news_sec top_news_sec" data-news-idx="0">
                    <div class="set_inner">
                        <header class="sec_head">
                ...
                <section class="news_sec top_news_sec is_active" data-news-idx="1">
                    <div class="set_inner">
                        <header class="sec_head">
                            <div class="btn_area mode_change_area">
                                <button class="btn_mode_change" onclick="toggleTopNewsSection(this, 0)">
                        ...
                        <div class="sec_body">
                            <div class="timeline_news_wrap">
                                <h3 class="timeline_ttl">오미크론, 그게 대체 뭔데? <img
            ...
            <div class="mk_body_news_group">
                <section class="news_sec special_news_sec type_list">
                    <header class="sec_head">
                        <img src="../../assets/images/img_special_banner01.png" alt="">
                        <div class="is_blind" role="img">
                            <h2>WORLD KNOWLEDGE FORUM 2021</h2>
                    ...
                    <div class="sec_body">
                        <div class="set_inner">
                            <div class="special_news_wrap">
                                <ul class="news_list special_news_list">
                                    <li class="news_node">
                                        <a href="#" class="news_item type_thumb2">
                                            <!--Dev: 썸네일은 background-image로-->
                                            <div class="thumb_area"
                                                 style="background-image: url(../../assets/images/img_special_01.png)"></div>
                                            <div class="txt_area">
                                                <h3 class="news_ttl">마이클 샌델,<br>
                                                    2021년 대한민국 공정을 말하다…</h3>
                                                <div class="info_group">
                                    ...
                                    <li class="news_node">
                                        <a href="#" class="news_item">
                                            <div class="thumb_area">
                                                <img src="../../assets/images/img_special_list02.png" alt="">
                                            </div>
                                            <div class="txt_area">
                                                <h3 class="news_ttl">장대환 회장, 부산을 수소경제 허브도시로…
                                                    박형준 시장, 기후변화협약 총회 유치할것</h3>
                                                <div class="info_group">
                                                    <p class="time_info">28분 전</p>
                                                    <p class="like_info">좋아요 <span>22</span></p>
                                                </div>
                                    ...
                                    <li class="news_node">
                                        <a href="#" class="news_item">
                                            <div class="thumb_area">
                                                <img src="../../assets/images/img_special_list03.png" alt="">
                                            </div>
                                            <div class="txt_area">
                                                <h3 class="news_ttl">코로나 지원금 공짜아냐…韓나랏빚 ‘경고등’</h3>
                                                <div class="info_group">
                                    ...
                                    <li class="news_node">
                                        <a href="#" class="news_item">
                                            <div class="thumb_area">
                                                <img src="../../assets/images/img_special_list05.png" alt="">
                                            </div>
                                            <div class="txt_area">
                                                <h3 class="news_ttl">야첵 올자크 필립모리스 글로벌 CEO, “한국도 일반 담배 판매를 중단할 수 있다”</h3>
                                                <div class="info_group">
                                ...
                                <ul class="news_list highlight_news_list">
                                    <li class="news_node highlight_news_node">
                                        <div class="news_item highlight_news_item type_thumb2">
                                            ...
                                            <div class="thumb_area"
                                                 style="background-image: url(../../assets/images/img_highlight_01.png)"></div>
                                ...
                                <ul class="news_list highlight_news_list">
                                    <li class="news_node highlight_news_node">
                                        <div class="news_item highlight_news_item type_thumb2">
                                            ...
                                            <!--Dev: 썸네일 이미지는 background-image로-->
                                            <div class="thumb_area"
                                                 style="background-image: url(../../assets/images/img_highlight_02.png)"></div>
                                            <div class="txt_area">
                        ...
                        <div class="sec_body">
                            <div class="newsletter_wrap">
                                <div class="newsletter_frame swiper-container">
                                  ...
                                  <div class="newsletter_pagination"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ul class="news_list stock_news_list">
                                        <li class="news_node">
                                            <a href="" class="news_item type_thumb2">
                                                ...
                                                <div class="txt_area">
                                                    <h3 class="news_ttl">“삼성과 격차 더 커졌다”…진격의 TSMC, 전세계 파운드리 `절반`
                                                        독식</h3>
                                                    <div class="info_group">
                                                        <p class="time_info">3분 전</p>
                                                        <p class="like_info">가장 댓글이 활발한 기사</p>
