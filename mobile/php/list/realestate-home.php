...
<header id="header">
  ...
  <?php include_once '../_inc/header/_SNB_realestate.php'; ?>
</header>
<!-- e: Header -->
<?php include_once '../_inc/header/_SummaryNewsUi.php'; ?>
  ...
  <!-- s: Container -->
  <main id="container">
    <h1 class="page_ttl is_blind">부동산홈</h1>
    <section class="contents list_page realestate_page">
                ...
                <ul class="news_list highlight_news_list grid">
                  <li class="news_node highlight_news_node">
                    <div class="news_item highlight_news_item type_thumb2">
                      <a href="#" aria-describedby="text" class="link">
                        <span class="is_blind">기사링크</span>
                      </a>
                      ...
                      <div id="text" class="txt_area">
                        ...
                        <div class="info_group">
                          <p class="time_info">2022.03.15</p>
      ...
      <div class="mk_body_news_group no_mt">
	              ...
	              <ul class="news_list latest_news_list">
		              <li class="news_node">
			              <div class="news_item">
				              ...
				              <div class="txt_area">
					              <h3 id="news1" class="news_ttl">정부 “신규확진 1만명까지는 대비…중환자 1~2주 안에 줄여야”</h3>
					              <div class="info_group">
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_02.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">“가상자산 불법 거래 금액 사상 최고치 경신”</h3>
					              <div class="info_group">
						              <p class="time_info">3분전</p>
						              <p class="like_info">좋아요 25</p>
					              </div>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_03.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">스벅 손님 10명중 1명은 ‘핑크음료’ 마셨다…“재료 떨어져 긴급…스벅 손님 10명중 1명은 ‘핑크음료’ 마셨다…“재료 떨어져
						              긴급…</h3>
					              <div class="info_group">
						              <p class="time_info">3분전</p>
						              <p class="like_info">좋아요 25</p>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_04.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">유승호, 내일(6일) ‘김영철의 파워FM’ 뜬다 [공식]유승호, 내일(6일) ‘김영철의 파워FM’ 뜬다 [공식]</h3>
					              <div class="info_group">
						              <p class="time_info">3분전</p>
						              <p class="like_info">좋아요 25</p>
					              </div>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_05.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">이정재, 美 SAG 남우주연상 노미네이트…韓남자 배우 최초</h3>
					              <div class="info_group">
						              <p class="time_info">3분전</p>
						              <p class="like_info">좋아요 25</p>
					              </div>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_06.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">정부 “신규확진 1만명까지는 대비…중환자 1~2주 안에 줄여야”</h3>
					              <div class="info_group">
						              <p class="time_info">3분전</p>
						              <p class="like_info">좋아요 25</p>
					              </div>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_07.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">“가상자산 불법 거래 금액 사상 최고치 경신”</h3>
					              <div class="info_group">
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_08.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">스벅 손님 10명중 1명은 ‘핑크음료’ 마셨다…“재료 떨어져 긴급…스벅 손님 10명중 1명은 ‘핑크음료’ 마셨다…“재료 떨어져
						              긴급…</h3>
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_09.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">유승호, 내일(6일) ‘김영철의 파워FM’ 뜬다 [공식]유승호, 내일(6일) ‘김영철의 파워FM’ 뜬다 [공식]</h3>
					              <div class="info_group">
		              ...
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_10.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">이정재, 美 SAG 남우주연상 노미네이트…韓남자 배우 최초</h3>
					              <div class="info_group">
		              ...
		              <li class="news_node ad_wrap">
			              <a href="#" class="news_item">
				              <img src="../../assets/images/img_latest_ad02.png" alt="">
			              </a>
		              </li>
		              <li class="news_node">
			              <div class="news_item">
				              <a href="#" class="link" aria-describedby="news1"></a>
				              <div class="thumb_area">
					              <img src="../../assets/images/img_latest_01.png" alt="">
				              </div>
				              <div class="txt_area">
					              <h3 class="news_ttl">정부 “신규확진 1만명까지는 대비…중환자 1~2주 안에 줄여야”</h3>
					              <div class="info_group">
