          ...
          <div class="set_inner">
            ...
            <div class="sec_body">
	            <div class="result_wrap">
		            <div class="result_head guide_ui taC">
			            <p><span>‘데이터’</span>에 대한 <b class="c_point">15</b>건의 검색결과입니다.</p>
		            </div>
		            <div class="result_body">
			            <ul class="result_list dot_list">
				            <li class="result_node">
					            <a href="#" class="result_item"><em>데이터</em>로 본 코로나시대</a>
				            </li>
				            <li class="result_node">
					            <a href="#" class="result_item"><em>데이터</em>로 본 코로나시대</a>
				            </li>
				            <li class="result_node">
					            <a href="#" class="result_item">디지털 금맥, 빅<em>데이터</em></a>
				            </li>
				            <li class="result_node">
					            <a href="#" class="result_item">빅<em>데이터</em>로 본 대통령 뉴리더십</a>
				            </li>
				            <li class="result_node">
					            <a href="#" class="result_item">빅<em>데이터</em>로 본 지역축제</a>
				            </li>
				            <li class="result_node">
					            <a href="#" class="result_item"><em>데이터</em>로 본 코로나시대</a>
				            </li>
