...
<!-- e: Header -->
  ...
  <main id="container">
    ...
    <section class="contents my_page myinfo_page">
      <div class="set_inner">
              ...
              <div class="info_wrap_body">
                ...
                <dl class="label_list is_check">
                  <dt>
                    ...
                    <p class="date">010-1234-5678</p>
                  </dt>
                  <dd>
                  </dd>
                </dl>
                <dl class="label_list add_area">
                  ...
                  <dd>
                    <div class="input_group type_addr">
                      <div class="input_area type_hrz">
                        ...
                        <button class="btn basic w_l h_xl">주소 수정</button>
                      </div>
                      <div class="input_area type_hrz">
                    ...
                    <div class="btn_area">
                      <button class="btn strong h_xl w_f">저장</button>
                    </div>
                  </dd>
                </dl>
              </div>
