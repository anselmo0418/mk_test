		...
		<section class="contents account_page change_pw_page is_fix">
			<div class="set_inner">
				<article class="account_sec">
					<h1 class="page_ttl taC">비밀번호 변경 안내</h1>
					<form action="" class="account_wrap account_form">
						...
						<div class="btn_area grid grid_4">
							<div class="col col_6"><a href="#" class="btn basic w_f h_xl">다음에 변경하기</a></div>
							<div class="col col_6"><a href="#" class="btn strong w_f h_xl">비밀번호 변경</a></div>
						</div>
					</form>
				</article>
			</div>
